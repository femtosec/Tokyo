...
class OrderValidatorTest {
    ...
    Object[][] createTestCasesForIsValidNewOrder() {
        [
                ...
                [ "BTC/JPY",    "CCH",      OrderSide.Buy,      Orderer.Strategy,   OrderDestination.Exchange,      0L,     "symbolList",   null,           true ],
                ...
                [ "BTC/JPY",    "CCH",      OrderSide.Buy,      Orderer.EMS,        OrderDestination.Exchange,      0L,     "symbolList",   null,           true ],
                [ "BTC/JPY",    "CCH",      OrderSide.Buy,      Orderer.EMS,        OrderDestination.Exchange,      0L,     "symbolList",   mockStrategy,   false ],
                [ "BTC/JPY",    "CCH",      OrderSide.Buy,      Orderer.EMS,        OrderDestination.Strategy,      0L,     "symbolList",   mockStrategy,   true ],
                [ "BTC/JPY",    "CCH",      OrderSide.Buy,      Orderer.EMS,        OrderDestination.Strategy,      0L,     "symbolList",   null,           false ],
